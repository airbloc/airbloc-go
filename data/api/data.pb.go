...
package api // import "github.com/airbloc/airbloc-go/data/api"
...
func (*BatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_d02bd66cbb1c3905, []int{0}
}
...
func (*DataId) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_d02bd66cbb1c3905, []int{1}
}
...
func (*DataResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_d02bd66cbb1c3905, []int{2}
}
...
func (*DataResult_Permission) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_d02bd66cbb1c3905, []int{2, 0}
}
...
func (*BatchGetResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_d02bd66cbb1c3905, []int{3}
}
...
func (*SetDataPermissionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_d02bd66cbb1c3905, []int{4}
}
...
func (*SetBatchDataPermissionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_d02bd66cbb1c3905, []int{5}
}
...
func init() { proto.RegisterFile("proto/data.proto", fileDescriptor_data_d02bd66cbb1c3905) }

var fileDescriptor_data_d02bd66cbb1c3905 = []byte{
	...
	0xa5, 0xc2, 0xc7, 0x2d, 0x67, 0xfb, 0x7d, 0xbd, 0x6a, 0xde, 0xcc, 0x71, 0xb2, 0xc9, 0x97, 0xae,
	0x7e, 0x17, 0xdf, 0xfc, 0x09, 0x00, 0x00, 0xff, 0xff, 0xa8, 0x6f, 0x5f, 0x56, 0x4c, 0x05, 0x00,
	0x00,
}
