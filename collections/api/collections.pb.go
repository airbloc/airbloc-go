...
func (*Policy) Descriptor() ([]byte, []int) {
	return fileDescriptor_collections_c1d902400d251391, []int{0}
}
...
func (*CreateCollectionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_collections_c1d902400d251391, []int{1}
}
...
func (*CreateCollectionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_collections_c1d902400d251391, []int{2}
}
...
func (*ListCollectionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_collections_c1d902400d251391, []int{3}
}
...
func (*CollectionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_collections_c1d902400d251391, []int{4}
}
...
func (*ListCollectionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_collections_c1d902400d251391, []int{5}
}
...
func init() {
	proto.RegisterFile("proto/collections.proto", fileDescriptor_collections_c1d902400d251391)
}

var fileDescriptor_collections_c1d902400d251391 = []byte{
