...
func (*DAuthSignUpRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dauth_a7f34e9ba6796258, []int{0}
}
...
func (dst *DAuthSignUpRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DAuthSignUpRequest.Merge(dst, src)
}
...
func (*DAuthSignUpResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dauth_a7f34e9ba6796258, []int{1}
}
...
func (dst *DAuthSignUpResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DAuthSignUpResponse.Merge(dst, src)
}
...
func (*DAuthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dauth_a7f34e9ba6796258, []int{2}
}
...
func (dst *DAuthRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DAuthRequest.Merge(dst, src)
}
...
func (*DAuthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dauth_a7f34e9ba6796258, []int{3}
}
...
func (dst *DAuthResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DAuthResponse.Merge(dst, src)
}
...
func init() { proto.RegisterFile("proto/p2p/v1/dauth.proto", fileDescriptor_dauth_a7f34e9ba6796258) }

var fileDescriptor_dauth_a7f34e9ba6796258 = []byte{
