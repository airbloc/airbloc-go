...
func (*DAuthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dauth_f4da012be0f52333, []int{0}
}
...
func init() {
	proto.RegisterFile("proto/rpc/v1/userdelegate/dauth.proto", fileDescriptor_dauth_f4da012be0f52333)
}

var fileDescriptor_dauth_f4da012be0f52333 = []byte{
