...
package userdelegate // import "github.com/airbloc/airbloc-go/proto/rpc/v1/userdelegate"

import proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import _ "github.com/airbloc/airbloc-go/proto/rpc/v1"
...
func (AccountGetResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_account_052bc1cebd4d8667, []int{3, 0}
}
...
func (*AccountCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_052bc1cebd4d8667, []int{0}
}
...
func (*AccountCreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_052bc1cebd4d8667, []int{1}
}
...
func (*AccountGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_052bc1cebd4d8667, []int{2}
}
...
func (*AccountGetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_052bc1cebd4d8667, []int{3}
}
...
func (dst *AccountGetResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccountGetResponse.Merge(dst, src)
}
...
func (*AccountGetByIdentityRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_052bc1cebd4d8667, []int{4}
}
...
func (dst *AccountGetByIdentityRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccountGetByIdentityRequest.Merge(dst, src)
}
...
func (*TestPasswordRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_052bc1cebd4d8667, []int{5}
}
...
func (dst *TestPasswordRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestPasswordRequest.Merge(dst, src)
}
...
func (*TestPasswordResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_052bc1cebd4d8667, []int{6}
}
...
func (dst *TestPasswordResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestPasswordResponse.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("proto/rpc/v1/userdelegate/account.proto", fileDescriptor_account_052bc1cebd4d8667)
}

var fileDescriptor_account_052bc1cebd4d8667 = []byte{
