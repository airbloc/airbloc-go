...
func (*BatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_135f7be2d14dd503, []int{0}
}
...
func (*DataId) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_135f7be2d14dd503, []int{1}
}
...
func (*DataResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_135f7be2d14dd503, []int{2}
}
...
func (*DataResult_Permission) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_135f7be2d14dd503, []int{2, 0}
}
...
func (*BatchGetResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_135f7be2d14dd503, []int{3}
}
...
func (*SetDataPermissionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_135f7be2d14dd503, []int{4}
}
...
func (*SetBatchDataPermissionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_135f7be2d14dd503, []int{5}
}
...
type DataClient interface {
	...
	SetPermission(ctx context.Context, in *SetDataPermissionRequest, opts ...grpc.CallOption) (*v1.Result, error)
	SetPermissionBatch(ctx context.Context, in *SetBatchDataPermissionRequest, opts ...grpc.CallOption) (*v1.Results, error)
	Delete(ctx context.Context, in *DataId, opts ...grpc.CallOption) (*v1.Result, error)
	DeleteBatch(ctx context.Context, in *BatchRequest, opts ...grpc.CallOption) (*v1.Results, error)
	Select(ctx context.Context, opts ...grpc.CallOption) (Data_SelectClient, error)
	Release(ctx context.Context, in *BatchRequest, opts ...grpc.CallOption) (*v1.Result, error)
}
...
func (c *dataClient) SetPermission(ctx context.Context, in *SetDataPermissionRequest, opts ...grpc.CallOption) (*v1.Result, error) {
	out := new(v1.Result)
...
func (c *dataClient) SetPermissionBatch(ctx context.Context, in *SetBatchDataPermissionRequest, opts ...grpc.CallOption) (*v1.Results, error) {
	out := new(v1.Results)
...
func (c *dataClient) Delete(ctx context.Context, in *DataId, opts ...grpc.CallOption) (*v1.Result, error) {
	out := new(v1.Result)
...
func (c *dataClient) DeleteBatch(ctx context.Context, in *BatchRequest, opts ...grpc.CallOption) (*v1.Results, error) {
	out := new(v1.Results)
...
func (c *dataClient) Release(ctx context.Context, in *BatchRequest, opts ...grpc.CallOption) (*v1.Result, error) {
	out := new(v1.Result)
...
type DataServer interface {
	...
	SetPermission(context.Context, *SetDataPermissionRequest) (*v1.Result, error)
	SetPermissionBatch(context.Context, *SetBatchDataPermissionRequest) (*v1.Results, error)
	Delete(context.Context, *DataId) (*v1.Result, error)
	DeleteBatch(context.Context, *BatchRequest) (*v1.Results, error)
	Select(Data_SelectServer) error
	Release(context.Context, *BatchRequest) (*v1.Result, error)
}
...
func init() {
	proto.RegisterFile("proto/rpc/v1/server/data.proto", fileDescriptor_data_135f7be2d14dd503)
}

var fileDescriptor_data_135f7be2d14dd503 = []byte{
	// 505 bytes of a gzipped FileDescriptorProto
	,
}
