...
func (*RawDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_warehouse_77cbe188e7df7fe1, []int{0}
}
...
func (*EncryptedDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_warehouse_77cbe188e7df7fe1, []int{1}
}
...
func (*StoreResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_warehouse_77cbe188e7df7fe1, []int{2}
}
...
func (*DeleteBundleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_warehouse_77cbe188e7df7fe1, []int{3}
}
...
func (*DeleteBundleResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_warehouse_77cbe188e7df7fe1, []int{4}
}
...
func init() {
	proto.RegisterFile("proto/rpc/v1/server/warehouse.proto", fileDescriptor_warehouse_77cbe188e7df7fe1)
}

var fileDescriptor_warehouse_77cbe188e7df7fe1 = []byte{
