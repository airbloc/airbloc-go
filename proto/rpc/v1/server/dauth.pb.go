...
func (*DAuthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dauth_ea196cdb5707daf6, []int{0}
}
...
func init() {
	proto.RegisterFile("proto/rpc/v1/server/dauth.proto", fileDescriptor_dauth_ea196cdb5707daf6)
}

var fileDescriptor_dauth_ea196cdb5707daf6 = []byte{
