...
func (*CreateSchemaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_schemas_f10c079c99ae77ca, []int{0}
}
...
func (*CreateSchemaResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_schemas_f10c079c99ae77ca, []int{1}
}
...
func init() {
	proto.RegisterFile("proto/rpc/v1/server/schemas.proto", fileDescriptor_schemas_f10c079c99ae77ca)
}

var fileDescriptor_schemas_f10c079c99ae77ca = []byte{
