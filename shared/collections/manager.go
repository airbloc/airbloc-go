...
func (s *Manager) Register(ctx context.Context, collection *Collection) (types.ID, error) {
	// damn EVM
...
func (s *Manager) Unregister(ctx context.Context, collectionId types.ID) error {
...
func (s *Manager) Get(id types.ID) (*Collection, error) {
...
func (s *Manager) ListID(ctx context.Context, appId types.ID) ([]types.ID, error) {
...
func (s *Manager) List(ctx context.Context, appId types.ID) ([]*Collection, error) {
...
func (s *Manager) Exists(id types.ID) (bool, error) {
	return s.contract.Exists(nil, id)
}

func (s *Manager) IsCollectionAllowed(id, userId types.ID) (bool, error) {
	return s.contract.IsCollectionAllowed(nil, id, userId)
}

func (s *Manager) GetContract() *adapter.CollectionRegistry {
	return s.contract
}
