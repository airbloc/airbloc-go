...
//
// Solidity: function apps(bytes8 ) constant returns(string name, address owner)
...
//
// Solidity: function exists(bytes8 _appId) constant returns(bool)
...
//
// Solidity: function isOwner(bytes8 _appId, address _owner) constant returns(bool)
...
func (_AppRegistry *AppRegistryTransactor) Register(opts *bind.TransactOpts, _name string) (*ethTypes.Transaction, error) {
...
//
// Solidity: function register(string _name) returns()
func (_AppRegistry *AppRegistrySession) Register(_name string) (*ethTypes.Transaction, error) {
...
//
// Solidity: function register(string _name) returns()
func (_AppRegistry *AppRegistryTransactorSession) Register(_name string) (*ethTypes.Transaction, error) {
	return _AppRegistry.Contract.Register(&_AppRegistry.TransactOpts, _name)
}
...
//
// Solidity: function transferAppOwner(bytes8 appId, address _newOwner) returns()
func (_AppRegistry *AppRegistryTransactor) TransferAppOwner(opts *bind.TransactOpts, appId [8]byte, _newOwner common.Address) (*ethTypes.Transaction, error) {
...
//
// Solidity: function transferAppOwner(bytes8 appId, address _newOwner) returns()
func (_AppRegistry *AppRegistrySession) TransferAppOwner(appId [8]byte, _newOwner common.Address) (*ethTypes.Transaction, error) {
...
//
// Solidity: function transferAppOwner(bytes8 appId, address _newOwner) returns()
func (_AppRegistry *AppRegistryTransactorSession) TransferAppOwner(appId [8]byte, _newOwner common.Address) (*ethTypes.Transaction, error) {
	return _AppRegistry.Contract.TransferAppOwner(&_AppRegistry.TransactOpts, appId, _newOwner)
}
...
//
// Solidity: function unregister(bytes8 _appId) returns()
func (_AppRegistry *AppRegistryTransactor) Unregister(opts *bind.TransactOpts, _appId [8]byte) (*ethTypes.Transaction, error) {
...
//
// Solidity: function unregister(bytes8 _appId) returns()
func (_AppRegistry *AppRegistrySession) Unregister(_appId [8]byte) (*ethTypes.Transaction, error) {
...
//
// Solidity: function unregister(bytes8 _appId) returns()
func (_AppRegistry *AppRegistryTransactorSession) Unregister(_appId [8]byte) (*ethTypes.Transaction, error) {
	return _AppRegistry.Contract.Unregister(&_AppRegistry.TransactOpts, _appId)
}
...
//
// Solidity: event Registered(string indexed name, bytes8 appId)
...
//
// Solidity: event Registered(string indexed name, bytes8 appId)
func (_AppRegistry *AppRegistryFilterer) ParseRegisteredFromReceipt(receipt *ethTypes.Receipt) (*AppRegistryRegistered, error) {
	for _, log := range receipt.Logs {
