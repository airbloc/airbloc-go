...
type IExchangeTransacts interface {
	AddDataIds(ctx context.Context, offerId types.ID, dataIds []types.DataId) (*klayTypes.Receipt, error)
	Cancel(ctx context.Context, offerId types.ID) (*klayTypes.Receipt, error)
	Order(ctx context.Context, offerId types.ID) (*klayTypes.Receipt, error)
	Prepare(ctx context.Context, provider string, consumer common.Address, escrow common.Address, escrowSign [4]byte, escrowArgs []byte, dataIds []types.DataId) (*klayTypes.Receipt, error)
	Reject(ctx context.Context, offerId types.ID) (*klayTypes.Receipt, error)
	Settle(ctx context.Context, offerId types.ID) (*klayTypes.Receipt, error)
}
...
type IExchangeParser interface {
	ParseEscrowExecutionFailedFromReceipt(receipt *klayTypes.Receipt) (*ExchangeEscrowExecutionFailed, error)
	ParseOfferCanceledFromReceipt(receipt *klayTypes.Receipt) (*ExchangeOfferCanceled, error)
	ParseOfferPreparedFromReceipt(receipt *klayTypes.Receipt) (*ExchangeOfferPrepared, error)
	ParseOfferPresentedFromReceipt(receipt *klayTypes.Receipt) (*ExchangeOfferPresented, error)
	ParseOfferReceiptFromReceipt(receipt *klayTypes.Receipt) (*ExchangeOfferReceipt, error)
	ParseOfferRejectedFromReceipt(receipt *klayTypes.Receipt) (*ExchangeOfferRejected, error)
	ParseOfferSettledFromReceipt(receipt *klayTypes.Receipt) (*ExchangeOfferSettled, error)
}
...
func (c *ExchangeContract) AddDataIds(ctx context.Context, offerId types.ID, dataIds []types.DataId) (*klayTypes.Receipt, error) {
...
func (c *ExchangeContract) Cancel(ctx context.Context, offerId types.ID) (*klayTypes.Receipt, error) {
...
func (c *ExchangeContract) Order(ctx context.Context, offerId types.ID) (*klayTypes.Receipt, error) {
...
func (c *ExchangeContract) Prepare(ctx context.Context, provider string, consumer common.Address, escrow common.Address, escrowSign [4]byte, escrowArgs []byte, dataIds []types.DataId) (*klayTypes.Receipt, error) {
...
func (c *ExchangeContract) Reject(ctx context.Context, offerId types.ID) (*klayTypes.Receipt, error) {
...
func (c *ExchangeContract) Settle(ctx context.Context, offerId types.ID) (*klayTypes.Receipt, error) {
