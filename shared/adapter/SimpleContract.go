...
func (_SimpleContract *SimpleContractRaw) Transfer(opts *bind.TransactOpts) (*ethTypes.Transaction, error) {
	return _SimpleContract.Contract.SimpleContractTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_SimpleContract *SimpleContractRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*ethTypes.Transaction, error) {
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_SimpleContract *SimpleContractTransactorRaw) Transfer(opts *bind.TransactOpts) (*ethTypes.Transaction, error) {
	return _SimpleContract.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_SimpleContract *SimpleContractTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*ethTypes.Transaction, error) {
...
//
// Solidity: function transact(address _token, uint256 _amount, bytes8 _offerId) returns()
func (_SimpleContract *SimpleContractTransactor) Transact(opts *bind.TransactOpts, _token common.Address, _amount *big.Int, _offerId [8]byte) (*ethTypes.Transaction, error) {
...
//
// Solidity: function transact(address _token, uint256 _amount, bytes8 _offerId) returns()
func (_SimpleContract *SimpleContractSession) Transact(_token common.Address, _amount *big.Int, _offerId [8]byte) (*ethTypes.Transaction, error) {
...
//
// Solidity: function transact(address _token, uint256 _amount, bytes8 _offerId) returns()
func (_SimpleContract *SimpleContractTransactorSession) Transact(_token common.Address, _amount *big.Int, _offerId [8]byte) (*ethTypes.Transaction, error) {
	return _SimpleContract.Contract.Transact(&_SimpleContract.TransactOpts, _token, _amount, _offerId)
}
