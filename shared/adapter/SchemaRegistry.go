...
func (_SchemaRegistry *SchemaRegistryRaw) Transfer(opts *bind.TransactOpts) (*ethTypes.Transaction, error) {
	return _SchemaRegistry.Contract.SchemaRegistryTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_SchemaRegistry *SchemaRegistryRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*ethTypes.Transaction, error) {
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_SchemaRegistry *SchemaRegistryTransactorRaw) Transfer(opts *bind.TransactOpts) (*ethTypes.Transaction, error) {
	return _SchemaRegistry.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_SchemaRegistry *SchemaRegistryTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*ethTypes.Transaction, error) {
...
//
// Solidity: function schemas(bytes8 ) constant returns(address owner, string name)
...
//
// Solidity: function register(string _name) returns()
func (_SchemaRegistry *SchemaRegistryTransactor) Register(opts *bind.TransactOpts, _name string) (*ethTypes.Transaction, error) {
...
//
// Solidity: function register(string _name) returns()
func (_SchemaRegistry *SchemaRegistrySession) Register(_name string) (*ethTypes.Transaction, error) {
...
//
// Solidity: function register(string _name) returns()
func (_SchemaRegistry *SchemaRegistryTransactorSession) Register(_name string) (*ethTypes.Transaction, error) {
	return _SchemaRegistry.Contract.Register(&_SchemaRegistry.TransactOpts, _name)
}
...
func (_SchemaRegistry *SchemaRegistryTransactor) Unregister(opts *bind.TransactOpts, _id [8]byte) (*ethTypes.Transaction, error) {
...
//
// Solidity: function unregister(bytes8 _id) returns()
func (_SchemaRegistry *SchemaRegistrySession) Unregister(_id [8]byte) (*ethTypes.Transaction, error) {
...
//
// Solidity: function unregister(bytes8 _id) returns()
func (_SchemaRegistry *SchemaRegistryTransactorSession) Unregister(_id [8]byte) (*ethTypes.Transaction, error) {
	return _SchemaRegistry.Contract.Unregister(&_SchemaRegistry.TransactOpts, _id)
}
...
//
// Solidity: event Registration(address indexed registrar, bytes8 _id)
...
//
// Solidity: event Registration(address indexed registrar, bytes8 _id)
func (_SchemaRegistry *SchemaRegistryFilterer) ParseRegistrationFromReceipt(receipt *ethTypes.Receipt) (*SchemaRegistryRegistration, error) {
...
//
// Solidity: event Unregistration(bytes8 indexed _id)
...
//
// Solidity: event Unregistration(bytes8 indexed _id)
func (_SchemaRegistry *SchemaRegistryFilterer) ParseUnregistrationFromReceipt(receipt *ethTypes.Receipt) (*SchemaRegistryUnregistration, error) {
	for _, log := range receipt.Logs {
