...
func (_ExchangeLib *ExchangeLibRaw) Transfer(opts *bind.TransactOpts) (*ethTypes.Transaction, error) {
	return _ExchangeLib.Contract.ExchangeLibTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ExchangeLib *ExchangeLibRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*ethTypes.Transaction, error) {
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ExchangeLib *ExchangeLibTransactorRaw) Transfer(opts *bind.TransactOpts) (*ethTypes.Transaction, error) {
	return _ExchangeLib.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ExchangeLib *ExchangeLibTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*ethTypes.Transaction, error) {
