...
func (_SparseMerkleTree *SparseMerkleTreeRaw) Transfer(opts *bind.TransactOpts) (*ethTypes.Transaction, error) {
	return _SparseMerkleTree.Contract.SparseMerkleTreeTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_SparseMerkleTree *SparseMerkleTreeRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*ethTypes.Transaction, error) {
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_SparseMerkleTree *SparseMerkleTreeTransactorRaw) Transfer(opts *bind.TransactOpts) (*ethTypes.Transaction, error) {
	return _SparseMerkleTree.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_SparseMerkleTree *SparseMerkleTreeTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*ethTypes.Transaction, error) {
...
//
// Solidity: function checkMembership(bytes32 root, uint64 leafID, bytes proof) constant returns(bool)
...
//
// Solidity: function getRoot(uint64 index, bytes proof) constant returns(bytes32)
