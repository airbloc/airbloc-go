...
func NewAirblocBackend(nodeKey *key.Key, config *service.Config) (service.Backend, error) {
...
func (airbloc *AirblocBackend) Config() *service.Config {
...
func (airbloc *AirblocBackend) GetService(name string) service.Service {
	return airbloc.services[name]
}

func (airbloc *AirblocBackend) AttachService(name string, service service.Service) {
