...
package api // import "github.com/airbloc/airbloc-go/schemas/api"
...
func (*CreateSchemaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_schemas_870b67c210580656, []int{0}
}
...
func (*CreateSchemaResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_schemas_870b67c210580656, []int{1}
}
...
func init() { proto.RegisterFile("proto/schemas.proto", fileDescriptor_schemas_870b67c210580656) }

var fileDescriptor_schemas_870b67c210580656 = []byte{
