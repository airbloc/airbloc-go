...
func (m *MockIERC20EscrowContract) Filterer() adapter.ERC20EscrowFilterer {
	ret := m.ctrl.Call(m, "Filterer")
	ret0, _ := ret[0].(adapter.ERC20EscrowFilterer)
	return ret0
}

// Filterer indicates an expected call of Filterer
func (mr *MockIERC20EscrowContractMockRecorder) Filterer() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Filterer", reflect.TypeOf((*MockIERC20EscrowContract)(nil).Filterer))
}
