...
func (m *MockISimpleTokenContract) Filterer() adapter.SimpleTokenFilterer {
	ret := m.ctrl.Call(m, "Filterer")
	ret0, _ := ret[0].(adapter.SimpleTokenFilterer)
	return ret0
}

// Filterer indicates an expected call of Filterer
func (mr *MockISimpleTokenContractMockRecorder) Filterer() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Filterer", reflect.TypeOf((*MockISimpleTokenContract)(nil).Filterer))
}
