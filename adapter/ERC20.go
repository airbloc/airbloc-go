...
//
// Solidity: e Approval(owner indexed address, spender indexed address, value uint256)
func (_ERC20 *ERC20Filterer) ParseApprovalFromReceipt(receipt *types.Receipt) (*ERC20Approval, error) {
...
//
// Solidity: e Transfer(from indexed address, to indexed address, value uint256)
func (_ERC20 *ERC20Filterer) ParseTransferFromReceipt(receipt *types.Receipt) (*ERC20Transfer, error) {
	for _, log := range receipt.Logs {
