...
//
// Solidity: e MinterAdded(account indexed address)
func (_MinterRole *MinterRoleFilterer) ParseMinterAddedFromReceipt(receipt *types.Receipt) (*MinterRoleMinterAdded, error) {
...
//
// Solidity: e MinterRemoved(account indexed address)
func (_MinterRole *MinterRoleFilterer) ParseMinterRemovedFromReceipt(receipt *types.Receipt) (*MinterRoleMinterRemoved, error) {
	for _, log := range receipt.Logs {
