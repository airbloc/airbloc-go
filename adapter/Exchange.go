...
func init() {
	...
	blockchain.RegisterSelector("0x386c0897", "addDataIds(bytes8,bytes32[])")
	blockchain.RegisterSelector("0x0cf833fb", "order(bytes8)")
	blockchain.RegisterSelector("0xe5576ec0", "prepare(address,address,bytes4,bytes,bytes32[])")
...
//
// Solidity: function getOffer(_offerId bytes8) constant returns(address, address, bytes32[], address, bytes4, bytes, uint8)
func (_Exchange *ExchangeCaller) GetOffer(opts *bind.CallOpts, _offerId [8]byte) (common.Address, common.Address, [][32]byte, common.Address, [4]byte, []byte, uint8, error) {
	var (
...
//
// Solidity: function getOffer(_offerId bytes8) constant returns(address, address, bytes32[], address, bytes4, bytes, uint8)
func (_Exchange *ExchangeSession) GetOffer(_offerId [8]byte) (common.Address, common.Address, [][32]byte, common.Address, [4]byte, []byte, uint8, error) {
...
//
// Solidity: function getOffer(_offerId bytes8) constant returns(address, address, bytes32[], address, bytes4, bytes, uint8)
func (_Exchange *ExchangeCallerSession) GetOffer(_offerId [8]byte) (common.Address, common.Address, [][32]byte, common.Address, [4]byte, []byte, uint8, error) {
	return _Exchange.Contract.GetOffer(&_Exchange.CallOpts, _offerId)
}
...
// AddDataIds is a paid mutator transaction binding the contract method 0x386c0897.
//
// Solidity: function addDataIds(_offerId bytes8, _dataIds bytes32[]) returns()
func (_Exchange *ExchangeTransactor) AddDataIds(opts *bind.TransactOpts, _offerId [8]byte, _dataIds [][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function addDataIds(_offerId bytes8, _dataIds bytes32[]) returns()
func (_Exchange *ExchangeSession) AddDataIds(_offerId [8]byte, _dataIds [][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function addDataIds(_offerId bytes8, _dataIds bytes32[]) returns()
func (_Exchange *ExchangeTransactorSession) AddDataIds(_offerId [8]byte, _dataIds [][32]byte) (*types.Transaction, error) {
	return _Exchange.Contract.AddDataIds(&_Exchange.TransactOpts, _offerId, _dataIds)
}
...
// Prepare is a paid mutator transaction binding the contract method 0xe5576ec0.
//
// Solidity: function prepare(_to address, _escrow address, _escrowSign bytes4, _escrowArgs bytes, _dataIds bytes32[]) returns()
func (_Exchange *ExchangeTransactor) Prepare(opts *bind.TransactOpts, _to common.Address, _escrow common.Address, _escrowSign [4]byte, _escrowArgs []byte, _dataIds [][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function prepare(_to address, _escrow address, _escrowSign bytes4, _escrowArgs bytes, _dataIds bytes32[]) returns()
func (_Exchange *ExchangeSession) Prepare(_to common.Address, _escrow common.Address, _escrowSign [4]byte, _escrowArgs []byte, _dataIds [][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function prepare(_to address, _escrow address, _escrowSign bytes4, _escrowArgs bytes, _dataIds bytes32[]) returns()
func (_Exchange *ExchangeTransactorSession) Prepare(_to common.Address, _escrow common.Address, _escrowSign [4]byte, _escrowArgs []byte, _dataIds [][32]byte) (*types.Transaction, error) {
	return _Exchange.Contract.Prepare(&_Exchange.TransactOpts, _to, _escrow, _escrowSign, _escrowArgs, _dataIds)
}
