...
// Prepare is a paid mutator transaction binding the contract method 0x43ef67fc.
//
// Solidity: function prepare(_from address, _to address, _escrow address, _escrowOpenSign bytes4, _escrowOpenArgs bytes, _escrowCloseSign bytes4, _escrowCloseArgs bytes, _dataIds bytes16[]) returns()
func (_Exchange *ExchangeTransactor) Prepare(opts *bind.TransactOpts, _from common.Address, _to common.Address, _escrow common.Address, _escrowOpenSign [4]byte, _escrowOpenArgs []byte, _escrowCloseSign [4]byte, _escrowCloseArgs []byte, _dataIds [][16]byte) (*types.Transaction, error) {
	return _Exchange.contract.Transact(opts, "prepare", _from, _to, _escrow, _escrowOpenSign, _escrowOpenArgs, _escrowCloseSign, _escrowCloseArgs, _dataIds)
}

// Prepare is a paid mutator transaction binding the contract method 0x43ef67fc.
//
// Solidity: function prepare(_from address, _to address, _escrow address, _escrowOpenSign bytes4, _escrowOpenArgs bytes, _escrowCloseSign bytes4, _escrowCloseArgs bytes, _dataIds bytes16[]) returns()
func (_Exchange *ExchangeSession) Prepare(_from common.Address, _to common.Address, _escrow common.Address, _escrowOpenSign [4]byte, _escrowOpenArgs []byte, _escrowCloseSign [4]byte, _escrowCloseArgs []byte, _dataIds [][16]byte) (*types.Transaction, error) {
	return _Exchange.Contract.Prepare(&_Exchange.TransactOpts, _from, _to, _escrow, _escrowOpenSign, _escrowOpenArgs, _escrowCloseSign, _escrowCloseArgs, _dataIds)
}

// Prepare is a paid mutator transaction binding the contract method 0x43ef67fc.
//
// Solidity: function prepare(_from address, _to address, _escrow address, _escrowOpenSign bytes4, _escrowOpenArgs bytes, _escrowCloseSign bytes4, _escrowCloseArgs bytes, _dataIds bytes16[]) returns()
func (_Exchange *ExchangeTransactorSession) Prepare(_from common.Address, _to common.Address, _escrow common.Address, _escrowOpenSign [4]byte, _escrowOpenArgs []byte, _escrowCloseSign [4]byte, _escrowCloseArgs []byte, _dataIds [][16]byte) (*types.Transaction, error) {
	return _Exchange.Contract.Prepare(&_Exchange.TransactOpts, _from, _to, _escrow, _escrowOpenSign, _escrowOpenArgs, _escrowCloseSign, _escrowCloseArgs, _dataIds)
}
...
//
// Solidity: e Receipt(_offerId indexed bytes8, _offeror indexed address, _to indexed address)
func (_Exchange *ExchangeFilterer) FilterReceipt(opts *bind.FilterOpts, _offerId [][8]byte, _offeror []common.Address, _to []common.Address) (*ExchangeReceiptIterator, error) {
	...
	logs, sub, err := _Exchange.contract.FilterLogs(opts, "Receipt", _offerIdRule, _offerorRule, _toRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: e Receipt(_offerId indexed bytes8, _offeror indexed address, _to indexed address)
func (_Exchange *ExchangeFilterer) WatchReceipt(opts *bind.WatchOpts, sink chan<- *ExchangeReceipt, _offerId [][8]byte, _offeror []common.Address, _to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Exchange.contract.WatchLogs(opts, "Receipt", _offerIdRule, _offerorRule, _toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
