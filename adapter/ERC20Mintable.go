...
//
// Solidity: e Approval(owner indexed address, spender indexed address, value uint256)
func (_ERC20Mintable *ERC20MintableFilterer) ParseApprovalFromReceipt(receipt *types.Receipt) (*ERC20MintableApproval, error) {
...
//
// Solidity: e MinterAdded(account indexed address)
func (_ERC20Mintable *ERC20MintableFilterer) ParseMinterAddedFromReceipt(receipt *types.Receipt) (*ERC20MintableMinterAdded, error) {
	for _, log := range receipt.Logs {
...
//
// Solidity: e MinterRemoved(account indexed address)
func (_ERC20Mintable *ERC20MintableFilterer) ParseMinterRemovedFromReceipt(receipt *types.Receipt) (*ERC20MintableMinterRemoved, error) {
	for _, log := range receipt.Logs {
...
//
// Solidity: e Transfer(from indexed address, to indexed address, value uint256)
func (_ERC20Mintable *ERC20MintableFilterer) ParseTransferFromReceipt(receipt *types.Receipt) (*ERC20MintableTransfer, error) {
	for _, log := range receipt.Logs {
