...
//
// Solidity: e Approval(owner indexed address, spender indexed address, value uint256)
func (_IERC20 *IERC20Filterer) ParseApprovalFromReceipt(receipt *types.Receipt) (*IERC20Approval, error) {
...
//
// Solidity: e Transfer(from indexed address, to indexed address, value uint256)
func (_IERC20 *IERC20Filterer) ParseTransferFromReceipt(receipt *types.Receipt) (*IERC20Transfer, error) {
	for _, log := range receipt.Logs {
