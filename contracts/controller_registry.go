...
//
// Solidity: function isController(address controller) constant returns(bool)
func (_ControllerRegistry *controllerRegistryCaller) IsController(ctx context.Context, controller common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0

	err := _ControllerRegistry.contract.Call(&bind.CallOpts{Context: ctx}, out, "isController", controller)
	return *ret0, err
}
...
//
// Solidity: function unregister(address controllerAddr) returns()
func (_ControllerRegistry *controllerRegistryTransactor) Unregister(
	ctx context.Context,
	opts *ablbind.TransactOpts,
	controllerAddr common.Address,
) (*chainTypes.Receipt, error) {
	...
	return _ControllerRegistry.contract.Transact(opts, "unregister", controllerAddr)
}
