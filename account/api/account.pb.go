...
package api // import "github.com/airbloc/airbloc-go/account/api"
...
func (*AccountCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_f28b9795f1e51d44, []int{0}
}
...
type AccountCreateResponse struct {
	AccountId            *api.Hash `protobuf:"bytes,1,opt,name=accountId,proto3" json:"accountId,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (*AccountCreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_f28b9795f1e51d44, []int{1}
}
...
func (m *AccountCreateResponse) GetAccountId() *api.Hash {
	if m != nil {
		return m.AccountId
	}
	return nil
...
func init() { proto.RegisterFile("proto/account.proto", fileDescriptor_account_f28b9795f1e51d44) }

var fileDescriptor_account_f28b9795f1e51d44 = []byte{
	...
	0x46, 0x4a, 0x8b, 0x18, 0xa5, 0x10, 0xf7, 0x39, 0x69, 0x47, 0x69, 0xa6, 0x67, 0x96, 0x64, 0x94,
	0x26, 0x81, 0x1c, 0xa3, 0x0f, 0xd5, 0x07, 0xa3, 0x75, 0xd3, 0xe1, 0xe1, 0xa4, 0x9f, 0x58, 0x90,
	0x99, 0xc4, 0x06, 0x0e, 0x04, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xca, 0xd7, 0x47, 0xeb,
	0x43, 0x01, 0x00, 0x00,
}
